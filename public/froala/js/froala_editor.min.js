...
!function(e, t) {
  ...
  V.MODULES.clean = function(f) {
      ...
      function c(e) {
          ...
          for (t in e)
              if (Object.prototype.hasOwnProperty.call(e, t)) {
                  ...
                  n && r ? e[t] = C(r.join(";")) : n && ("style" !== t || r) || delete e[t]
              }
      ...
      function L(e) {
          ...
          !function c(a) {
              ...
              a.nodeType === Node.ELEMENT_NODE && (a.getAttribute("data-fr-src") && 0 !== a.getAttribute("data-fr-src").indexOf("blob:") && a.setAttribute("data-fr-src", f.helpers.sanitizeURL(b(a.getAttribute("data-fr-src")))),
                  ...
                  if (a.tagName && a.tagName.match(p))
                      ...
                      if (n)
                          for (var r = n.length - 1; 0 <= r; r--) {
                              ...
                              i && s ? o.value = C(s.join(";")) : i && ("style" !== o.nodeName || s) || a.removeAttribute(o.nodeName)
                          }
                  }
              else
      ...
      return {
          _startEnter: function b(e) {
              ...
              if (g.node.isEmpty(n, !0) && r) {
                  ...
                  for (var u = "".concat(V.MARKERS, "<br>"), h = e.parentNode; h && "LI" !== h.tagName; )
                      ...
                      h = h.parentNode;
                  t.parentNode && "LI" === t.parentNode.tagName ? C(t.parentNode).after("<li>".concat(u, "</li>")) : i ? C(t).after("<".concat(i, ">").concat(u, "</").concat(i, ">")) : C(t).after(u),
                  C(n).remove()
              } else
                  (t = v(n)).parentNode && "LI" === t.parentNode.tagName ? r ? C(t.parentNode).before("".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>")) : C(t.parentNode).after("".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>")) : i ? C(t).before("<".concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">")) : C(t).before("".concat(V.MARKERS, "<br>")),
                  C(n).remove()
          },
          _middleEnter: function c(e) {
              for (var t = m(e), n = "", r = e, o = "", i = "", a = !1; r !== t; ) {
                  ...
                  o += V.INVISIBLE_SPACE),
                  o = g.node.openTagString(C(r).clone().addClass(s).get(0)) + o,
          ...
          _endEnter: function l(e) {
              for (var t = m(e), n = V.MARKERS, r = "", o = e, i = !1; o !== t; )
                  if (!(o = o.parentNode).classList.contains("fr-img-space-wrap") && !o.classList.contains("fr-img-space-wrap2")) {
                      ...
                      r += V.INVISIBLE_SPACE),
                      r = g.node.openTagString(C(o).clone().addClass(a).get(0)) + r,
          ...
          _backspace: function d(e) {
              ...
              if (n) {
                  ...
                  for (n = t.previousSibling; i; )
                      ...
                      C(n).append(i),
                      i = o;
                  1 < (r = g.node.contents(n)).length && "BR" === r[r.length - 1].tagName && C(r[r.length - 1]).remove(),
                  C(t).remove()
              } else {
                  var a = v(t);
                  if (C(e).replaceWith(V.MARKERS),
                  ...
                  C(t).remove(),
                  g.html.wrap(),
                  0 === C(a).find("li").length && C(a).remove()
              }
          },
          _del: function f(e) {
              ...
              if (r) {
                  ...
                  C(r).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                  ...
                  if (s = s.nextSibling,
                  g.node.isBlock(s))
                      V.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (C(e).replaceWith(V.MARKERS),
                      (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(),
                      C(n).append(C(s).html()),
                      C(s).remove());
                  else
                      for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(),
                      C(e).replaceWith(V.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName; )
                          C(n).append(C(s)),
                          s = s.nextSibling
              }
          }
  ...
  V.MODULES.cursor = function(u) {
      ...
      function l(e, t, n) {
          ...
          if (o && "BLOCKQUOTE" === o.tagName)
              return C(e, o) ? (r = u.html.defaultTag(),
      ...
      function m(e, t, n) {
          ...
          if (null === r)
              ...
              do {
                  ...
                  "BLOCKQUOTE" !== r.tagName || !C(e, o) && !g(e, o))
  ...
  V.MODULES.data = function(f) {
      ...
      function g() {
          return; // hack // othewise froala destoys after 10 modifications
          if (10 < e && (f[p(N("0ppecjvc=="))](),
          setTimeout(function() {
              L.FE = null
          }, 10)),
          !f.$box)
      ...
      return {
          _init: function x() {
              ...
              for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                  var l = (r = e[s],
                  4 === (o = (N(r) || "").split("|")).length && "V3" === o[0] ? [o[1], o[3], o[2]] : [null, null, ""])
                    , c = l[2];
                  if (c === N(p(N("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(M, c.length - M.length) || C(M) || m()) {
                      ...
                      1)) : new Date(n) < new Date(N(S))) || !(0 < (M || "").length) || C(M) || m()) {
                          f.ul = !1;
                          break
                      }
                      i = !0,
              ...
              var d = new Image;
              !0 === f.ul && (g(),
              d.src = i ? "".concat(p(N(t)), "e=").concat(a) : "".concat(p(N(t)), "u")),
  ...
  V.MODULES.format = function(v) {
      ...
      function C(e, t, n) {
          if (e) {
              for (; e.nodeType === Node.COMMENT_NODE; )
                  e = e.nextSibling;
              if (e) {
                  if (v.node.isBlock(e) && "HR" !== e.tagName)
                      return v.node.hasClass(e.firstChild, "fr-marker") ? C(e.firstChild.nextSibling, t, n) : C(e.firstChild, t, n),
                      !1;
                  ...
                  for (var o = e; o && !b(o).is(".fr-marker") && 0 === b(o).find(".fr-marker").length && "UL" !== o.tagName && "OL" !== o.tagName; ) {
                      var i = o;
                      if (v.node.isBlock(o) && "HR" !== e.tagName)
                          return C(o.firstChild, t, n),
                          !1;
                      o = o.nextSibling,
                      r.append(i)
                  }
                  if (o) {
                      if (b(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName)
                          C(o.firstChild, t, n);
                      else if (v.browser.mozilla && v.node.hasClass(o, "fr-marker")) {
                          var a, s = v.selection.blocks(), l = s.length;
                          for (a = 0; a < l; a++)
                              s[a] != o.parentNode && s[a].childNodes.length && s[a].childNodes[0] != o.parentNode && (o = s[a].childNodes[1] || s[a].childNodes[0],
                              (r = b(f(t, n)).insertBefore(o)).append(o))
                      }
                  } else {
                      for (var c = r.get(0).parentNode; c && !c.nextSibling && !v.node.isElement(c); )
                          c = c.parentNode;
                      if (c) {
                          var d = c.nextSibling;
      ...
      function n(e, t) {
          ...
          v.selection.isCollapsed()) {
              v.markers.insert(),
              v.$el.find(".fr-marker").replaceWith(f(e, t) + V.INVISIBLE_SPACE + V.MARKERS + function a(e) {
                  return "</".concat(e, ">")
              }(e)),
              v.selection.restore()
          } else {
              var r;
              v.selection.save(),
              C(v.$el.find('.fr-marker[data-type="true"]').length && v.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
              do {
                  for (r = v.$el.find("".concat(L(e, t), " > ").concat(L(e, t))),
                  n = 0; n < r.length; n++)
      ...
      function y(e, t, n, r) {
          if (!r) {
              var o = !1;
              if (!0 === e.data("type"))
                  for (; v.node.isFirstSibling(e.get(0)) && !e.parent().is(v.$el) && !e.parent().is("ol") && !e.parent().is("ul"); )
                      e.parent().before(e),
                      o = !0;
              else if (!1 === e.data("type"))
                  for (; v.node.isLastSibling(e.get(0)) && !e.parent().is(v.$el) && !e.parent().is("ol") && !e.parent().is("ul"); )
                      e.parent().after(e),
                      o = !0;
              if (o)
                  return !0
          ...
          if (e.parents(t).length || void 0 === t) {
              ...
              if (l.is(v.$el) || v.node.isBlock(l.get(0)))
                  return !1;
              for (; !(v.node.isBlock(l.parent().get(0)) || void 0 !== t && E(l.get(0), L(t, n))); )
                  a += v.node.closeTagString(l.get(0)),
                  s = v.node.openTagString(l.get(0)) + s,
                  l = l.parent();
      ...
      function r(e, t) {
          ...
          !function C(e, t, n, r) {
              for (var o = v.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                  ...
                  v.node.hasClass(a, "fr-marker"))
                      t = (t + 1) % 2;
                  else if (t)
                      if (0 < b(a).find(".fr-marker").length)
                          t = C(b(a), t, n, r);
                      else {
                      ...
                      0 < b(a).find(".fr-marker").length && (t = C(b(a), t, n, r))
              }
              return t
          }(v.$el, 0, e, t),
          n || (v.$el.find(".fr-marker").remove(),
          v.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),
      ...
      function t(e, t) {
          ...
          if (v.selection.isCollapsed()) {
              ...
              if (v.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                  if (v.node.isEmpty(l.get(0)))
                      s = b(v.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)),
                      l.replaceWith(s);
                  else {
                      var c = {};
                      c["style*"] = "".concat(e, ":"),
                      ...
                      t ? (s = b(v.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)),
                      r.replaceWith(s)) : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS)
                  }
                  v.html.cleanEmptyTags()
              } else
                  v.node.isEmpty(l.get(0)) && l.is("span") ? (r.replaceWith(V.MARKERS),
                  l.css(e, t)) : (s = b('<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>")),
                  r.replaceWith(s));
              s && m(s, e, t)
          } else {
              if (v.selection.save(),
              null === t || "color" === e && 0 < v.$el.find(".fr-marker").parents("u, a").length) {
                  var d = v.$el.find(".fr-marker");
                  for (n = 0; n < d.length; n++)
                      if (!0 === (r = b(d[n])).data("type") || "true" === r.data("type"))
                          for (; v.node.isFirstSibling(r.get(0)) && !r.parent().is(v.$el) && !v.node.isElement(r.parent().get(0)) && !v.node.isBlock(r.parent().get(0)); )
                              r.parent().before(r);
                      else
                          for (; v.node.isLastSibling(r.get(0)) && !r.parent().is(v.$el) && !v.node.isElement(r.parent().get(0)) && !v.node.isBlock(r.parent().get(0)); )
                              r.parent().after(r)
              }
              for (var f = v.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; f.firstChild; )
                  f = f.firstChild;
              var p = {
              ...
              (t || "").match(/\dem$/) && v.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed"); 0 < v.$el.find("span.fr-unprocessed").length; ) {
                  if ((s = v.$el.find("span.fr-unprocessed").first().removeClass("fr-unprocessed")).parent().get(0).normalize(),
          ...
          !function g() {
              var e;
              for (; 0 < v.$el.find(".fr-split:empty").length; )
                  v.$el.find(".fr-split:empty").remove();
              v.$el.find(".fr-split").removeClass("fr-split"),
              v.$el.find('[style=""]').removeAttr("style"),
              v.$el.find('[class=""]').removeAttr("class"),
              v.html.cleanEmptyTags();
              ...
              for (e = 0; e < o.length; e++) {
                  var i = b(o[e])
                    , a = b(o[e]).prev();
                  i.get(0).previousSibling === a.get(0) && v.node.openTagString(i.get(0)) === v.node.openTagString(a.get(0)) && (i.prepend(a.html()),
                  a.remove())
              }
              v.$el.find("span[style] span[style]").each(function() {
                  if (0 <= b(this).attr("style").indexOf("font-size")) {
                      var e = b(this).parents("span[style]");
                      0 <= e.attr("style").indexOf("background-color") && (b(this).attr("style", "".concat(b(this).attr("style"), ";").concat(e.attr("style"))),
                      y(b(this), "span[style]", {}, !1))
                  }
              }),
              v.el.normalize(),
              v.selection.restore()
      ...
      function m(e, t, n) {
          var r, o, i, a = e.parentsUntil(v.$el, "span[style]"), s = [];
          for (r = a.length - 1; 0 <= r; r--)
              o = a[r],
              i = t,
              0 === b(o).attr("style").indexOf("".concat(i, ":")) || 0 <= b(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= b(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
          if ((a = a.not(s)).length) {
              ...
              a.get(0) !== p && (d += v.node.closeTagString(p),
              f = v.node.openTagString(b(p).clone().addClass("fr-split").get(0)) + f),
              a.get(0) !== p; )
                  ;
      ...
      function o(e, t) {
          ...
          !n.collapsed && r.nodeType === Node.TEXT_NODE && n.startOffset === (r.textContent || "").length) {
              for (; !v.node.isBlock(r.parentNode) && !r.nextSibling; )
                  r = r.parentNode;
              r.nextSibling && (r = r.nextSibling)
          }
          for (var o = r; o && o.nodeType === Node.ELEMENT_NODE && !E(o, L(e, t)); )
              o = o.firstChild;
          if (o && o.nodeType === Node.ELEMENT_NODE && E(o, L(e, t)))
              return !0;
          var i = r;
          for (i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType === Node.ELEMENT_NODE && i !== v.el && !E(i, L(e, t)); )
              i = i.parentNode;
              ...
              if (0 < a.length) {
                  ...
                  try {
                      ...
                      if (o.nextSibling === a || a.nextSibling === o) {
                          ...
                          if (h && (E.node.isVoid(h) || E.node.isBlock(h)) && (h = null),
                      ...
                      if (!l) {
                          var m = void 0
                            , v = void 0;
                          v = (E.browser.chrome || E.browser.edge) && o.nextSibling === a ? (m = N(a, i, !0) || i.setStartAfter(a),
                          N(o, i, !1) || i.setEndBefore(o)) : (o.previousSibling === a && (a = (o = a).nextSibling),
          ...
          blocks: function h() {
              ...
              if (p() && r.rangeCount) {
                  ...
                  for (e = 0; e < o.length; e++) {
                      ...
                      (E.node.isBlock(a) || E.node.hasClass(a, "fr-inner")) && n.indexOf(a) < 0 && n.push(a),
                      (t = E.node.blockParent(a)) && n.indexOf(t) < 0 && n.push(t);
                      ...
                      E.node.isBlock(s) && n.indexOf(s) < 0 && 0 < i.endOffset && n.push(s),
                      (t = E.node.blockParent(s)) && n.indexOf(t) < 0 && n.push(t)
                  }
              }
  ...
  V.MODULES.html = function(O) {
      ...
      function i(e) {
          ...
          if (e) {
              ...
              r = O.el.querySelectorAll(p());
          var l = p();
          for (l += ",".concat(V.VOID_ELEMENTS.join(",")),
          l += ", .fr-inner",
          l += ",".concat(O.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"),
          t = r.length - 1; 0 <= t; t--)
      ...
      function a(e, t) {
          ...
          n) {
              for (var r = O.doc.createDocumentFragment(), o = null, i = !1, a = e.firstChild, s = !1; a; ) {
                  var l = a.nextSibling;
                  if (a.nodeType === Node.ELEMENT_NODE && (O.node.isBlock(a) || 0 <= O.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) && !O.node.hasClass(a, "fr-marker")))
                      o = null,
                      ...
                      null === o ? (o = O.doc.createElement(n),
                      s = !0,
                      t && (o.setAttribute("class", "fr-temp-div"),
                      o.setAttribute("data-empty", !0)),
                      o.appendChild(a.cloneNode(!0)),
                      r.appendChild(o)) : !1 === i && (o.appendChild(O.doc.createElement("br")),
                      t && (o.setAttribute("class", "fr-temp-div"),
                      o.setAttribute("data-empty", !0))),
                      o = null;
                  else {
                      var c = a.textContent;
                      a.nodeType !== Node.TEXT_NODE || 0 < c.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length || c.replace(/(^ *)|( *$)/g, "").length && c.indexOf("\n") < 0 ? (null === o && (o = O.doc.createElement(n),
                      s = !0,
                      t && o.setAttribute("class", "fr-temp-div"),
                      r.appendChild(o),
                      i = !1),
                      o.appendChild(a.cloneNode(!0)),
                      i || O.node.hasClass(a, "fr-marker") || a.nodeType === Node.TEXT_NODE && 0 === c.replace(/ /g, "").length || (i = !0)) : s = !0
                  }
                  a = l
              }
              s && (e.innerHTML = "",
              ...
              if (!s(n.parentNode, !0)) {
                  ...
                  if (r) {
                      var i = n.previousSibling
                        , a = n.nextSibling;
                      i && a && " " === o ? o = O.node.isBlock(i) && O.node.isBlock(a) ? "" : " " : (i || (o = o.replace(/^ */, "")),
                      a || (o = o.replace(/ *$/, "")))
                  }
                  n.textContent = o
              }
      ...
      function c(e) {
          ...
          if (t && (O.node.isBlock(t) || O.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
              ...
              !t || O.node.isBlock(t) || O.node.isElement(t) || e.previousSibling || e.nextSibling || !O.node.isDeletable(e.parentNode) || c(e.parentNode)
      }
      function g() {
          O.opts.htmlUntouched || (e(),
          t(),
          n(),
      ...
      function o() {
          O.node.isEmpty(O.el) && (null !== d() ? O.el.querySelector(p()) || O.el.querySelector("".concat(O.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || (O.core.hasFocus() ? (O.$el.html("<".concat(d(), ">").concat(V.MARKERS, "<br/></").concat(d(), ">")),
          O.selection.restore()) : O.$el.html("<".concat(d(), "><br/></").concat(d(), ">"))) : O.el.querySelector("*:not(.fr-marker):not(br)") || (O.core.hasFocus() ? (O.$el.html("".concat(V.MARKERS, "<br/>")),
          O.selection.restore()) : O.$el.html("<br/>")))
      }
      function C(e, t) {
      ...
      function k(e) {
          if (O.events.trigger("html.processGet", [e]),
      ...
      function B() {
          for (var e = O.el.querySelectorAll("input, textarea"), t = 0; t < e.length; t++)
              "checkbox" !== e[t].type && "radio" !== e[t].type || (e[t].checked ? e[t].setAttribute("checked", e[t].checked) : O.$(e[t]).removeAttr("checked")),
      ...
      function u(e) {
          var t = null;
          if (void 0 === e && (t = O.selection.element()),
          O.opts.keepFormatOnDelete)
              return !1;
          var n, r, o = t ? (t.textContent.match(/\u200B/g) || []).length - t.querySelectorAll(".fr-marker").length : 0;
          if ((O.el.textContent.match(/\u200B/g) || []).length - O.el.querySelectorAll(".fr-marker").length === o)
              return !1;
          do {
              r = !1,
              n = O.el.querySelectorAll("*:not(.fr-marker)");
              for (var i = 0; i < n.length; i++) {
                  var a = n[i];
                  if (t !== a) {
                      var s = a.textContent;
                      0 === a.children.length && 1 === s.length && 8203 === s.charCodeAt(0) && "TD" !== a.tagName && (h(a).remove(),
                      r = !0)
                  }
              }
          } while (r)
      ...
      return {
          ...
          set: function T(e) {
              ...
              if (O.opts.fullPage) {
                  ...
                  O.$html.attr(f),
                  O.iframe_document.doctype.parentNode.replaceChild(function u(e, t) {
          ...
          get: function _(e, t) {
              if (!O.$wp)
                  return O.$oel.clone().removeClass("fr-view").removeAttr("contenteditable").get(0).outerHTML;
              var n = "";
              ...
              !O.opts.useClasses && !t) {
                  ...
                  for (r = 0; r < O.doc.styleSheets.length; r++) {
                      ...
                      try {
                          ...
                          O.doc.styleSheets[r].ownerNode && "STYLE" === O.doc.styleSheets[r].ownerNode.nodeType && (d = 1)
                      } catch (x) {}
                      if (c)
                              ...
                              if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                                  ...
                                  for (o = 0; o < h.length; o++) {
                                      ...
                                      for (var g = 1e3 * d + $(c[f].selectorText), C = c[f].style.cssText.split(";"), m = 0; m < C.length; m++) {
                                          ...
                                          if (v && !v.match(l) && (a[h[o]][v] || (a[h[o]][v] = 0) <= (h[o].getAttribute("fr-original-style") || "").indexOf("".concat(v, ":")) && (a[h[o]][v] = 1e4),
                                          g >= a[h[o]][v] && (a[h[o]][v] = g,
                                          C[m].trim().length))) {
                          ...
                          for (o = 0; o < E.length; o++)
                              if (0 < E[o].indexOf(":")) {
                                  var y = E[o].split(":")
                                    , S = y[0];
                                  y.splice(0, 1),
                                  i[r].style[S.trim()] = y.join(":").trim()
                              }
                      }
              }
              if (O.node.isEmpty(O.el))
                  O.opts.fullPage && (n = w(O.iframe_document),
                  n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.find("head").get(0).outerHTML, "<body></body></html>"));
          ...
          getSelected: function M() {
              function e(e, t) {
                  for (; t && (t.nodeType === Node.TEXT_NODE || !O.node.isBlock(t)) && !O.node.isElement(t) && !O.node.hasClass(t, "fr-inner"); )
                      t && t.nodeType !== Node.TEXT_NODE && h(e).wrapInner(O.node.openTagString(t) + O.node.closeTagString(t)),
                      t = t.parentNode;
              ...
              if ("undefined" != typeof O.win.getSelection) {
                  O.browser.mozilla && (O.selection.save(),
                  1 < O.$el.find('.fr-marker[data-type="false"]').length && (O.$el.find('.fr-marker[data-type="false"][data-id="0"]').remove(),
                  O.$el.find('.fr-marker[data-type="false"]:last').attr("data-id", "0"),
                  ...
                  for (var o = O.selection.ranges(), i = 0; i < o.length; i++) {
                      ...
                      e(a, (n = t = void 0,
                      n = null,
                      O.win.getSelection ? (t = O.win.getSelection()) && t.rangeCount && (n = t.getRangeAt(0).commonAncestorContainer).nodeType !== Node.ELEMENT_NODE && (n = n.parentNode) : (t = O.doc.selection) && "Control" !== t.type && (n = t.createRange().parentElement()),
                      null !== n && (0 <= h(n).parents().toArray().indexOf(O.el) || n === O.el) ? n : null)),
                      0 < h(a).find(".fr-element").length && (a = O.el),
                      r += a.innerHTML
                  }
              } else
                  "undefined" != typeof O.doc.selection && "Text" === O.doc.selection.type && (r = O.doc.selection.createRange().htmlText);
              return r
          },
          insert: function N(e, t, n) {
              var r;
              if (O.selection.isCollapsed() || O.selection.remove(),
              r = t ? e : O.clean.html(e),
              e.indexOf('class="fr-marker"') < 0 && (r = function a(e) {
                  var t = O.doc.createElement("div");
                  return t.innerHTML = e,
                  O.selection.setAtEnd(t, !0),
                  t.innerHTML
              }(r)),
                  ...
                  if (o) {
                      ...
                      if ((f(r) || n) && (O.node.deepestParent(o) || i && "LI" === i.tagName)) {
                          if (i && "LI" === i.tagName && (r = function s(e) {
                              if (!O.html.defaultTag())
                                  return e;
                              var t = O.doc.createElement("div");
                              t.innerHTML = e;
                              for (var n = t.querySelectorAll(":scope > ".concat(O.html.defaultTag())), r = n.length - 1; 0 <= r; r--) {
                                  var o = n[r];
                                  O.node.isBlock(o.previousSibling) || (o.previousSibling && !O.node.isEmpty(o) && h("<br>").insertAfter(o.previousSibling),
                                  o.outerHTML = o.innerHTML)
                              }
                              return t.innerHTML
                          }(r)),
          ...
          unwrap: function A() {
              O.$el.find("div.fr-temp-div").each(function() {
                  ...
                  h(this).attr("data-empty") || !this.nextSibling || O.node.isBlock(this.nextSibling) && !h(this.nextSibling).hasClass("fr-temp-div") ? h(this).replaceWith(h(this).html()) : h(this).replaceWith("".concat(h(this).html(), "<br>"))
              }),
  ...
  V.MODULES.keys = function(d) {
      ...
      function L(e) {
          var t = e.which;
          if (m(e) || 37 <= t && t <= 40 || !b(t) && t !== V.KEYCODE.DELETE && t !== V.KEYCODE.BACKSPACE && t !== V.KEYCODE.ENTER && t !== V.KEYCODE.IME)
              return !0;
          n || (r = d.snapshot.get(),
  ...
  V.MODULES.paste = function(N) {
      ...
      function t(e) {
          ...
          if (e && e.clipboardData && e.clipboardData.getData) {
              ...
              /text\/html/.test(t) && !N.browser.safari ? a = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && N.browser.safari ? a = s : /public.rtf/.test(t) && N.browser.safari && (a = e.clipboardData.getData("text/rtf")),
              "" !== a)
                  return d(),
          ...
          return function o() {
              ...
              a = null,
              i ? (i.html(""),
              N.browser.edge && N.opts.iframe && N.$el.append(i)) : (i = x('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'),
              N.browser.webkit || N.browser.mozilla ? (i.css("top", N.$sc.scrollTop()),
              N.$el.after(i)) : N.browser.edge && N.opts.iframe ? N.$el.append(i) : N.$box.after(i),
              ...
              i.focus(),
              N.helpers.isIOS() && N.$sc && N.$sc.scrollTop(e);
      ...
      function r(e) {
          ...
          if (e && e.dataTransfer && e.dataTransfer.getData) {
              ...
              /text\/html/.test(t) ? a = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && N.browser.safari ? a = s : /text\/plain/.test(t) && !this.browser.mozilla && (a = N.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")),
              "" !== a) {
                  N.keys.forceUndo(),
                  A = N.snapshot.get(),
                  N.selection.save(),
                  N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
                  var o = N.markers.insertAtPoint(e);
                  if (N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"),
      ...
      function d() {
          ...
          (!e || e && !1 !== N.events.trigger("paste.wordPaste", [a])) && o(a, e)
      }
      function O(e) {
          for (var t = "", n = 0; n++ < e; )
              t += "&nbsp;";
      ...
      function o(e, t, n) {
          ...
          e = w(e = function y(e) {
              ...
              return N.html.cleanBlankSpaces(i),
              e = i.innerHTML
          }(e))),
          N.opts.pastePlain && !l && (e = function S(e) {
          ...
          "" !== e) {
              ...
              0 <= (f.innerHTML = e).indexOf("<body>") ? (N.html.cleanBlankSpaces(f),
              N.spaces.normalize(f, !0)) : N.spaces.normalize(f);
              ...
              var C = N.selection.element()
                , m = !1;
              if (C && x(C).parentsUntil(N.el, "ul, ol").length && (m = !0),
              m) {
                  var v = f.children;
              ...
              if (N.opts.enter === V.ENTER_BR)
                  ...
                  N.opts.enter === V.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
              e = f.innerHTML,
              l && (e = function T(e) {
      ...
      return {
          _init: function u() {
              ...
              N.el.addEventListener("paste", t, {
                  capture: !0
              }),
              N.events.on("drop", r),
              N.browser.msie && N.browser.version < 11 && (N.events.on("mouseup", function(e) {
  ...
  V.MODULES.popups = function(f) {
      ...
      function n(e) {
          var t = null;
          if (t = "string" != typeof e ? e : u[e],
          "filesManager.insert" === e && f.filesManager !== undefined && f.filesManager.isChildWindowOpen())
              return !1;
          if (t && f.node.hasClass(t, "fr-active") && (t.removeClass("fr-active fr-above"),
      ...
      function c(e, t) {
          ...
          if (!r)
              ...
              o.data("container", n),
              u[e] = o;
          "filesManager.insert" === e ? o.addClass("fr-popup fr-files-manager".concat(f.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(f.opts.toolbarInline ? " fr-inline" : "")) : o.addClass("fr-popup".concat(f.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(f.opts.toolbarInline ? " fr-inline" : "")),
          o.html(r),
          ...
          return {
              ...
              _windowMouseup: function(e) {
                  if (!f.core.sameInstance(o))
                      return !0;
                  var t = o.data("instance") || f;
                  o.isVisible() && l() && (e.stopPropagation(),
                  t.markers.remove(),
                  t.popups.hide(r),
                  v())
              },
      ...
      function L(e, t) {
          ...
          f.events.on("blur", function() {
              C() && f.markers.remove(),
              f.helpers.isMobile() ? u[t].hasClass("focused") ? (m(),
              u[t].removeClass("focused")) : u[t].addClass("focused") : u[t].find("iframe").length || m()
          }),
      ...
      return f.shared.exit_flag = !1,
      {
          ...
          get: function T(e) {
              var t = u[e];
              return t && !t.data("inst".concat(f.id)) && L(b(e), e),
              t
          },
          show: function M(e, t, n, r, o) {
              if (g(e) || (C() && 0 < f.$el.find(".fr-marker").length ? (f.events.disableBlur(),
              f.selection.restore()) : C() || (f.events.disableBlur(),
              f.events.focus(),
              f.events.enableBlur())),
              m([e]),
              !u[e])
          ...
          setPopupDimensions: function w(e, t) {
              ...
              f.popups.get("filesManager.insert").addClass("fr-height-auto"),
                      ...
                      _tiKeydown: function(e) {
                          ...
                          if (V.KEYCODE.TAB === n) {
                              ...
                              if (V.KEYCODE.ENTER !== n || !e.target || "TEXTAREA" === e.target.tagName)
                                  ...
                                  E(d)) : t.popups.isVisible(c) && d.findVisible(".fr-dismiss").length ? t.button.exec(d.findVisible(".fr-dismiss").first()) : (t.popups.hide(c),
          ...
          exec: function x(e, t) {
              ...
              return r !== V.KEYCODE.TAB || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.TAB || n || !e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ENTER && r !== V.KEYCODE.SPACE || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ESC || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (o = c()) : o = function i(e) {
                  if (f.shared.$f_el) {
                      ...
                      E(e.parent())) : f.shared.$f_el.is("button, .fr-group span") && (e.parent().is(".fr-popup") ? (f.accessibility.restoreSelection(),
                      f.shared.$f_el = null,
  ...
  V.MODULES.position = function(L) {
      ...
      function o() {
          ...
          if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
              var t = !1;
              0 === L.$el.find(".fr-marker").length && (L.selection.save(),
              t = !0);
      ...
      function r() {
          if (L.helpers.requestAnimationFrame()(r),
      ...
      return {
          _init: function s() {
              !function e() {
                  ...
                  }, !0)) : ("body" !== L.opts.scrollableContainer && L.events.$on(E(L.opts.scrollableContainer), "scroll", a, !0),
  ...
  V.MODULES.toolbar = function(C) {
      ...
      function e(e) {
          ...
          if (Array.isArray(e)) {
              ...
              "object" !== N(e) || Array.isArray(e) || ((n = e).showMoreButtons = !0);
          return n
      }
      function b() {
      ...
      function r() {
          if (m !== C.helpers.screenSize()) {
              ...
              e) {
                  ...
                  if (o.buttons) {
                      ...
                      for (var c = 0; c < o.buttons.length; c++) {
                          ...
                          C.node.hasClass(d.next().get(0), "fr-options") && (d.removeClass("fr-hidden"),
                      ...
                      if (e.showMoreButtons && s < a) {
                          ...
                          if (0 < p.length)
                              ...
                              var u = r
                                , h = V.COMMANDS[u];
                              h.more_btn = !0,
                              p = v(C.button.build(u, h, !0)),
                              C.button.addButtons(p)
                          }
                          l.append(p)
                      }
                      t.push(l),
              ...
              C.opts.toolbarBottom ? (C.$tb.append(n),
              C.$tb.find(".fr-newline").remove(),
              C.$tb.append('<div class="fr-newline"></div>'),
              C.$tb.append(t)) : (C.$tb.append(t),
              C.$tb.find(".fr-newline").remove(),
              C.$tb.append('<div class="fr-newline"></div>'),
              C.$tb.append(n)),
      ...
      function n(e, t) {
          setTimeout(function() {
              if ((!e || e.which != V.KEYCODE.ESC) && C.selection.inEditor() && C.core.hasFocus() && !C.popups.areVisible() && "false" != v(C.selection.blocks()[0]).closest("table").attr("contenteditable") && (C.opts.toolbarVisibleWithoutSelection || !C.selection.isCollapsed() && !C.keys.isIME() || t)) {
                  if (C.$tb.data("instance", C),
                  !1 === C.events.trigger("toolbar.show", [e]))
                      return;
                  C.$tb.show(),
                  C.opts.toolbarContainer || C.position.forSelection(C.$tb),
                  1 < C.opts.zIndex ? C.$tb.css("z-index", C.opts.zIndex + 1) : C.$tb.css("z-index", null)
              }
          }, 0)
      }
      function o(e) {
      ...
      function a(e) {
          clearTimeout(i),
          e && e.which === V.KEYCODE.ESC || (i = setTimeout(n, C.opts.typingTimer))
      }
      function s() {
          ...
          C.helpers.isMobile() ? C.helpers.isIOS() || (C.events.on("window.touchend", n),
          C.browser.mozilla && setInterval(n, 200)) : C.events.on("window.keyup", a),
          ...
          C.helpers.isMobile() && (C.events.$on(C.$doc, "selectionchange", a),
          C.events.$on(C.$doc, "orientationchange", n))
      }
      function l() {
          C.$tb.html("").removeData().remove(),
          C.$tb = null,
          C.$second_tb && (C.$second_tb.html("").removeData().remove(),
          C.$second_tb = null)
      }
      function c() {
          C.$box.removeClass("fr-top fr-bottom fr-inline fr-basic"),
          C.$box.find(".fr-sticky-dummy").remove()
      }
      function d() {
          ...
          C.opts.toolbarContainer ? (C.opts.toolbarInline && (s(),
          o()),
          C.opts.toolbarBottom ? C.$tb.addClass("fr-bottom") : C.$tb.addClass("fr-top")) : function e() {
              C.opts.toolbarInline ? (C.$sc.append(C.$tb),
              C.$tb.data("container", C.$sc),
              C.$tb.addClass("fr-inline"),
              s(),
              C.opts.toolbarBottom = !1) : (C.opts.toolbarBottom && !C.helpers.isIOS() ? (C.$box.append(C.$tb),
              C.$tb.addClass("fr-bottom"),
              C.$box.addClass("fr-bottom")) : (C.opts.toolbarBottom = !1,
              C.$box.prepend(C.$tb),
              C.$tb.addClass("fr-top"),
              C.$box.addClass("fr-top")),
              C.$tb.addClass("fr-basic"),
              C.opts.toolbarSticky && (C.opts.toolbarStickyOffset && (C.opts.toolbarBottom ? C.$tb.css("bottom", C.opts.toolbarStickyOffset) : C.$tb.css("top", C.opts.toolbarStickyOffset)),
              C.position.addSticky(C.$tb)))
          }(),
          function t() {
              var e = C.button.buildGroup(b());
              C.$tb.append(e),
              L(),
              C.button.bindCommands(C.$tb)
          }(),
          function n() {
              C.events.$on(v(C.o_win), "resize", r),
              C.events.$on(v(C.o_win), "orientationchange", r)
          }(),
          C.accessibility.registerToolbar(C.$tb),
          C.events.$on(C.$tb, "".concat(C._mousedown, " ").concat(C._mouseup), function(e) {
              var t = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null;
              if (t && "INPUT" !== t.tagName && !C.edit.isDisabled())
                  return e.stopPropagation(),
                  e.preventDefault(),
                  !1
          }, !0),
          C.helpers.isMobile() && C.events.$on(C.$tb, "click", function() {
              C.$el.focus()
          }),
          C.events.$on(C.$tb, "transitionend", ".fr-more-toolbar", function() {
              C.$box.hasClass("fr-fullscreen") && (C.opts.height = C.o_win.innerHeight - (C.opts.toolbarInline ? 0 : C.$tb.outerHeight() + (C.$second_tb ? C.$second_tb.outerHeight() : 0)),
              C.size.refresh())
          })
      }
      var f = !1;
      return {
          _init: function p() {
              if (C.$sc = v(C.opts.scrollableContainer).first(),
              !C.$wp)
                  return !1;
              C.opts.toolbarInline || C.opts.toolbarBottom || (C.$second_tb = v(C.doc.createElement("div")).attr("class", "second-toolbar"),
              C.$box.append(C.$second_tb),
              (!1 !== C.ul || C.opts.attribution) && C.$second_tb.prepend(V.POWERED_BY)),
              C.opts.toolbarContainer ? (C.shared.$tb ? (C.$tb = C.shared.$tb,
              C.opts.toolbarInline && s()) : (C.shared.$tb = v(C.doc.createElement("DIV")),
              C.shared.$tb.addClass("fr-toolbar"),
              C.$tb = C.shared.$tb,
              v(C.opts.toolbarContainer).append(C.$tb),
              d(),
              ...
              C.opts.toolbarInline = !1) : C.opts.toolbarInline ? (C.$box.addClass("fr-inline"),
              C.shared.$tb ? (C.$tb = C.shared.$tb,
              s()) : (C.shared.$tb = v(C.doc.createElement("DIV")),
              C.shared.$tb.addClass("fr-toolbar"),
              C.$tb = C.shared.$tb,
              d())) : (C.$box.addClass("fr-basic"),
              C.$tb = v(C.doc.createElement("DIV")),
              C.$tb.addClass("fr-toolbar"),
              d(),
              C.$tb.data("instance", C)),
              ...
              function e() {
                  C.events.on("shortcut", function(e, t, n) {
                      var r;
                      if (t && !n ? r = C.$tb.find('.fr-command[data-cmd="'.concat(t, '"]')) : t && n && (r = C.$tb.find('.fr-command[data-cmd="'.concat(t, '"][data-param1="').concat(n, '"]'))),
                      r.length && (e.preventDefault(),
                      e.stopPropagation(),
                      r.parents(".fr-toolbar").data("instance", C),
                      "keydown" === e.type))
                          return C.button.exec(r),
                          !1
                  })
              }()
          },
          hide: o,
          show: function u() {
              if (!1 === C.events.trigger("toolbar.show"))
                  return !1;
              C.$tb.show()
          },
          showInline: n,
          disable: function h() {
              !f && C.$tb && (C.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command").addClass("fr-disabled fr-no-refresh").attr("aria-disabled", !0),
              f = !0)
          },
          enable: function g() {
              f && C.$tb && (C.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command").removeClass("fr-disabled fr-no-refresh").attr("aria-disabled", !1),
              f = !1),
  ...
  h.fn = h.prototype = {
      ...
      prepend: function(e) {
          return; // hack against licnese notice
          if (0 == this.length)
              return this;
          if ("string" == typeof e)
              for (var t = 0; t < this.length; t++) {
